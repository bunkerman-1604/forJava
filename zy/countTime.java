...
public class countTime{
	...
	public static int[] JQ(int parseInt, int i) {
		...
		int[]		JQDay 	= {0,0};
		double		D	= 0.2422;
		double[]	C0	= {4.63,19.46,6.38,21.416,5.59,20.888,6.318,21.86,6.500,22.20,7.928,23.65,8.35,23.95,8.440,23.822,9.098,24.218,8.218,23.08,7.90,22.60,6.1100,20.84};
		...
		if (parseInt/100 == 19){
			if(i == 1 || i == 2){
				if(Y == 0){
					JQDay[0]	= (int) (Y*D+C0[(i*2+20)%24]);
					JQDay[1]	= (int) (Y*D+C0[(i*2+21)%24]);
				}else{
					JQDay[0]	= (int) (Y*D+C0[(i*2+20)%24]-(Y-1)/4);
					JQDay[1]	= (int) (Y*D+C0[(i*2+21)%24]-(Y-1)/4);
				}
			}else{
				JQDay[0]	= (int) (Y*D+C0[(i*2+20)%24]-Y/4);
				JQDay[1]	= (int) (Y*D+C0[(i*2+21)%24]-Y/4);
			}
		}else if (parseInt/100 == 20){
			if(i == 1 || i == 2){
				if(Y == 0){
