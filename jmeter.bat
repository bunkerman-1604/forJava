...
set PERM=-XX:PermSize=128m -XX:MaxPermSize=256m -XX:+CMSClassUnloadingEnabled
...
set ARGS=%DUMP% %HEAP% %NEW% %SURVIVOR% %TENURING% %PERM% %DDRAW% -server -Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=5000
